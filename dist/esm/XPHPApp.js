import{_ as t,a as e}from"./_rollupPluginBabelHelpers-ed8cbb08.js";import{L as i,c as s,h as n}from"./lit-element-3fe2c8b5.js";import{P as o,h as r,a,d as l,u as h,D as c,b as d,e as p}from"./iron-flex-layout-2a75219c.js";import"./XPHPBranding.js";import{getBasePathWithTrailingSlash as u}from"./utilities.js";import"./redux-775a3885.js";import"./lazy-reducer-enhancer-e37d5640.js";import"./middleware.js";import"./types.js";import"./value.js";import"./index.js";import"./initialState.js";import{store as f}from"./configureStore.js";import{c as _}from"./lit-redux-router-813ce0f2.js";import"./connect-mixin-144a42a2.js";import"./creators.js";import"./dispatchers.js";import"./DecrementButton.js";import"./IncrementButton.js";import"./XPHPStore.js";import"./XPHPCounter.js";import"./iron-button-state-7242b070.js";import"./XPHPDrawer.js";import{X_PHP_DRAWER_TOGGLE as g}from"./events.js";import"./XPHPHamburger.js";
/**
@license
...
o({_template:r`
    ...
    <slot></slot>
`,is:"app-toolbar"}),_(f);class v extends i{constructor(){super(...arguments),t(this,"_path",u())}static get styles(){return s(w())}static get properties(){return{siteTitle:{reflect:!1,type:String},siteUrl:{reflect:!1,type:String}}}_handleDrawerToggle(){var t=arguments.length>0&&void 0!==arguments[0]&&arguments[0],e=this.shadowRoot.querySelector("app-drawer");""!==e.getAttribute("opened")&&!0!==t?e.setAttribute("opened",""):e.removeAttribute("opened")}firstUpdated(){this.addEventListener(g,t=>{var{detail:e}=t;this._handleDrawerToggle(e)})}render(){return n(S(),this.siteTitle,this.siteUrl,()=>import("./XPHPScript.js"),this._path,()=>import("./XPHPScript.js"),this._path,this._path)}}export{v as XPHPApp};
